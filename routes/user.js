...
router.get(
  "/delete-address/:ind",
  userCont.verifyLogin,
  userCont.getDeleteAddressId
);
...
router.get(
  "/add-to-wishlist/:id",
  userCont.verifyLogin,
  userCont.getAddToWishlist
);

router.get(
  "/wishlist-remove/:id",
  userCont.verifyLogin,
  userCont.getWishlistRemove
);
...
router.get(
  "/cancel-order/:id",
  userCont.verifyLogin,
  userCont.getCancelOrderId
);

router.get(
  "/return-order/:id",
  userCont.verifyLogin,
  userCont.getReturnOrderId
);
